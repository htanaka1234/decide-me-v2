...
`draft_export.py` from a sidecar DraftDecisionSet plus the current project head. They follow the same
managed Markdown-region discipline, but they are draft-review artifacts, not canonical document
models.
